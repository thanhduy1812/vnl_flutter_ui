...
class _CodeBlockFutureBuilderState extends State<CodeBlockFutureBuilder> {
  ...
  void _refresh() {
    //https://raw.githubusercontent.com/thanhduy1812/vnl_flutter_ui/master/vnl_ui_docs/lib/pages/docs/layout_page/layout_page_example_1.dart
    String url =
        'https://raw.githubusercontent.com/thanhduy1812/vnl_flutter_ui/master/vnl_ui_docs/${widget.path}';
    futureCode =
              ...
              actions: [
                VNLGhostButton(
                  ...
                  onPressed: () {
                    // open in new tab
                    String url =
                        'https://github.com/thanhduy1812/vnl_flutter_ui/blob/master/docs/${widget.path}';
          ...
          return CodeBlock(
            ...
            actions: [
              VNLGhostButton(
                ...
                onPressed: () {
                  // open in new tab
                  //https://github.com/thanhduy1812/vnl_flutter_ui/blob/master/docs/lib/pages/docs/layout_page/layout_page_example_1.dart
                  String url =
                      'https://github.com/thanhduy1812/vnl_flutter_ui/blob/master/docs/${widget.path}';
                  // html.window.open(url, 'blank');
                  launchUrlString(url);
