          ...
          children: [
                      ...
                      children: [
                        ...
                        CollapsibleContent(
                          child: OutlinedContainer(
                            child:
                                const Text('@flutter/flutter').small().mono().withPadding(horizontal: 16, vertical: 8),
                          ).withPadding(top: 8),
                        ),
                        CollapsibleContent(
                          child: OutlinedContainer(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: MenuPopup(children: [
                          ...
                          Button(
                            style: const ButtonStyle.menu().copyWith(decoration: (context, states, value) {
                              return (value as BoxDecoration).copyWith(
                                color: theme.colorScheme.accent,
                                borderRadius: BorderRadius.circular(theme.radiusSm),
                              );
                            ...
                            children: [
                              Button(
                                ...
                                child: Basic(
                                  ...
                                  content: const Text('How to install Shadcn/UI for Flutter').muted(),
              ...
              ComponentCard(
                ...
                example: Column(
                  ...
                  children: [
                    ...
                    Transform.translate(offset: const Offset(250, 0), child: const Card(child: PaginationExample1())),
                  ],
                ).gap(16),
              ),
              ComponentCard(
            ...
            wrap(children: [
              ...
              ComponentCard(
                ...
                title: 'Calendar',
                scale: 1,
                example: Calendar(view: CalendarView.now(), selectionMode: CalendarSelectionMode.none),
              ),
              const ComponentCard(
                name: 'command',
                title: 'Command',
          ...
          child: ExcludeFocus(
            child: SizedBox(
              ...
              child: AnimatedValueBuilder(
                  ...
                  builder: (context, value, child) {
                    final borderColor = Color.lerp(theme.colorScheme.border, theme.colorScheme.ring, value);
                                      ...
                                      child: widget.fit
                                          ...
                                          : widget.center
                                              ...
                                              : Stack(
                                                  children: [
                                                    Positioned(
                                                      top: !widget.reverseVertical ? widget.verticalOffset : null,
                                                      right: widget.reverse ? widget.horizontalOffset : null,
                                                      bottom: widget.reverseVertical ? widget.verticalOffset : null,
                                                      left: !widget.reverse ? widget.horizontalOffset : null,
                                                      child: Transform.scale(
                                                        scale: widget.scale,
