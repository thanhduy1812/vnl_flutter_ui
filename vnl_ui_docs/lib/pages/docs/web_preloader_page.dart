        ...
        child: Column(
          ...
          children: [
            ...
            Alert(
              ...
              content:
                  const Text('You can use the CLI to create a web preloader for your flutter web application. See ')
                      .thenButton(
                          onPressed: () {
            ...
            Steps(
              children: [
                ...
                StepItem(
                  ...
                  content: [
                    const Text('You can customize the preloader by modifying the "flutter_bootstrap.js" file.').p(),
                    const Text(
