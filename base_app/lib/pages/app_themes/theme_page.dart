  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        GridView.count(crossAxisCount: 4, shrinkWrap: true, children: colors.keys.map(buildGridTile).toList()).p(),
        const Text('Premade color schemes').h2().anchored(premadeColorSchemeKey),
        // Text('You can also use premade color schemes.').p(),
        const Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Expanded(child: Text('You can also use premade color schemes to customize the look and feel of your app.')),
          ],
        ).p(),
        ...
        const Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [Expanded(child: Text('You can customize how rounded your app looks by changing the radius.'))],
        ).p(),
        VNLSlider(
        ...
        const Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [Expanded(child: Text('You can customize the blur of the surface by changing the surface blur.'))],
        ).p(),
        VNLSlider(
        ...
        CodeSnippet(code: customColorScheme ? buildCustomCode() : buildPremadeCode(), mode: 'dart').p(),
      ],
    );
  }
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: getInvertedColor(colors[name]!)),
                        ),
                      ),
                    ],
                  ),
