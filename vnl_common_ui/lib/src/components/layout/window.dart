    ...
    return Data<WindowHandle>.inherit(
      ...
      child: ListenableBuilder(
        ...
        builder: (context, child) {
                  ...
                  ClickDetector(
                    ...
                    child: GestureDetector(
                      ...
                      onPanStart: (details) {
                        ...
                        if (_entry != null) {
                          _viewport?.navigator._state._startDraggingWindow(_entry!, details.globalPosition);
                        }
                        if (state.maximized != null) {
                          ...
                          if (layerRenderBox != null) {
                            ...
                            Size titleSize = Size(this.bounds.width, 32 * theme.scaling);
                      ...
                      onPanUpdate: (details) {
                        ...
                        if (_entry != null) {
                          _viewport?.navigator._state._updateDraggingWindow(_entry!, details.globalPosition);
                        }
                      },
                      onPanEnd: (details) {
                        if (_entry != null) {
          ...
          windowClient = IgnorePointer(ignoring: _viewport?.ignorePointer ?? false, child: windowClient);
                ...
                if (resizable && maximized == null && _dragAlignment == null) ...[
                  ...
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.topLeft + delta, bounds.bottomRight);
                      },
                    ),
                  ),
                  // top right
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: -1,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.topRight + delta, bounds.bottomLeft);
                      },
                    ),
                  ),
                  // bottom left
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: 1,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.bottomLeft + delta, bounds.topRight);
                      },
                    ),
                  ),
                  // bottom right
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: 1,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.bottomRight + delta, bounds.topLeft);
                      },
                    ),
                  ),
                  // top
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: -1,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.topLeft + Offset(0, delta.dy), bounds.bottomRight);
                      },
                    ),
                  ),
                  // bottom
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: 1,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.bottomLeft + Offset(0, delta.dy), bounds.topRight);
                      },
                    ),
                  ),
                  // left
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: 0,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.topLeft + Offset(delta.dx, 0), bounds.bottomRight);
                      },
                    ),
                  ),
                  // right
                  GroupPositioned(
                    ...
                    child: _wrapResizer(
                      ...
                      adjustmentY: 0,
                      onResize: (bounds, delta) {
                        return Rect.fromPoints(bounds.topRight + Offset(delta.dx, 0), bounds.bottomLeft);
                      },
                    ),
                  ),
                ],
...
class WindowNavigator extends StatefulWidget {
  ...
  const WindowNavigator({super.key, required this.initialWindows, this.child});
...
class Window {
  ...
  final GlobalKey<_WindowWidgetState> _key = GlobalKey<_WindowWidgetState>(debugLabel: 'Window');
      ...
      children: [
        ...
        if (handle._snappingStrategy.value != null &&
          ...
          GroupPositioned.fromRect(
            ...
            child: _BlurContainer(key: ValueKey(handle._snappingStrategy.value)),
          ),
        ListenableBuilder(
                                        ...
                                        return GroupWidget(
                                          children: [
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 0.5, 1)),
                                              topRight: true,
                                              bottomRight: true,
                                            ),
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0.5, 0, 0.5, 1)),
                                              topLeft: true,
                                              bottomLeft: true,
                                            ),
                                          ],
                                        ...
                                        return GroupWidget(
                                          children: [
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 0.7, 1)),
                                              topRight: true,
                                              bottomRight: true,
                                            ),
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0.7, 0, 0.3, 1)),
                                              topLeft: true,
                                              bottomLeft: true,
                                            ),
                                          ],
                                        ...
                                        return GroupWidget(
                                          children: [
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0.0, 0.5, 1.0)),
                                              topRight: true,
                                              bottomRight: true,
                                            ),
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0.5, 0, 0.5, 0.5)),
                                              bottomLeft: true,
                                              bottomRight: true,
                                              topLeft: true,
                                            ),
                                        ...
                                        return GroupWidget(
                                          children: [
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 0.5, 0.5)),
                                              bottomRight: true,
                                              topRight: true,
                                              bottomLeft: true,
                                            ),
                                            ...
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0.5, 0.5, 0.5)),
                                              topLeft: true,
                                              topRight: true,
                                              bottomRight: true,
                                            ),
                                        ...
                                        return GroupWidget(
                                          children: [
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 1 / 3, 1)),
                                              topRight: true,
                                              bottomRight: true,
                                            ),
                                            createPaneSnapStrategy(
                                        ...
                                        return GroupWidget(
                                          children: [
                                            createPaneSnapStrategy(
                                              size,
                                              theme,
                                              const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 2 / 7, 1)),
                                              topRight: true,
                                              bottomRight: true,
                                            ),
                                            createPaneSnapStrategy(
            ...
            return ClipRect(
              child: GroupWidget(
                children: [
                  ...
                  _WindowLayerGroup(constraints: constraints, windows: _windows, handle: this, alwaysOnTop: false),
                  _WindowLayerGroup(constraints: constraints, windows: _topWindows, handle: this, alwaysOnTop: true),
                  GroupPositioned(
                    top: 0,
                    left: 0,
                    right: 0,
                    ...
                    child: _createBorderSnapStrategy(
                      const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 1, 1), shouldMinifyWindow: false),
                    ),
                  ),
                  GroupPositioned(
                    ...
                    child: _createBorderSnapStrategy(
                      const WindowSnapStrategy(relativeBounds: Rect.fromLTWH(0, 0, 0.5, 1), shouldMinifyWindow: false),
                    ),
                  ),
                  GroupPositioned(
                    top: 32 * theme.scaling,
            ...
            onPressed: () {
              if (handle != null) {
                if (handle.maximized != null) {
                  ...
                  handle.maximized =
                      viewport?.navigator._state._snappingStrategy.value?.relativeBounds ??
