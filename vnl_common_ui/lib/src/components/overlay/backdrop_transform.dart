...
/// sheets via [VNLBackdropTransformData].
///
/// The default implementation is [VNLScaleBackdropTransform], which scales the
/// backdrop from `1.0` down to a smaller factor (see [kBackdropScaleDown]).
abstract class VNLBackdropTransform {
  /// Const constructor for subclasses.
  const VNLBackdropTransform();
  ...
  static const VNLBackdropTransform none = VNLNoBackdropTransform();
...
/// A [VNLBackdropTransform] that leaves the backdrop untouched.
class VNLNoBackdropTransform extends VNLBackdropTransform {
  /// Creates an identity backdrop transform.
  const VNLNoBackdropTransform();
...
/// The default [VNLBackdropTransform]: scales the backdrop down from `1.0` to
...
class VNLScaleBackdropTransform extends VNLBackdropTransform {
  ...
  const VNLScaleBackdropTransform({
