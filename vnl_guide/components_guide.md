...
- [VNLPrimaryBadge](#primarybadge)
- [VNLSecondaryBadge](#secondarybadge)
- [VNLOutlineBadge](#outlinebadge)
...
**Description:** VNLTooltip widget for VNL UI, supporting custom theming and placement.

**Usage:**

```dart
VNLTooltip(
  message: 'VNLTooltip text',
  child: Icon(Icons.info),
)
```

**Note:** Do not confuse with VNLTooltip from Material 3.
...
**Description:** VNLPagination widget for VNL UI, supporting custom theming and navigation.
...
- **Name:** `VNLPrimaryButton`, `VNLSecondaryButton`, `VNLOutlineButton`, ...
...
showDialog(
  ...
  builder: (context) => AlertDialog(
    ...
    actions: [
      VNLPrimaryButton(child: Text('OK'), onPressed: () {}),
    ],
  ),
);
```
...
- **Name:** `VNLPrimaryBadge`, `VNLSecondaryBadge`, ...
...
![VNLSpinner](./docs_images/spinner.png)

**Description:** VNLSpinner widget for loading states.
